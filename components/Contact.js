...
const Contact = () => {
  ...
  <div className="container px-6 pt-6">
      ...
      <Link a href="https://www.linkedin.com/in/ayat-albqoor/" target="_blank" rel="noreferrer" type="button" className="rounded-full border-2 border-[#1f2937] text-[#1f2937] leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
        <svg aria-hidden="true"
        focusable="false"
        data-prefix="fab"
